...
describe "Admin login" do
  describe "happy path" do
    it "I can log in as an admin and get to my dashboard" do
	    admin = User.create(username: "superuser@awesome-site.com", email: "superuser@awesome-site.com",
                        password: "super_secret_passw0rd", password_confirmation: "super_secret_passw0rd",
                        role: 2)
